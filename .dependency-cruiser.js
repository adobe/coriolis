      ...
      dot: {
        ...
        */
        theme: {
          ...
          modules: [
            {
              criteria: { source: "^src/serializer" },
              attributes: { fillcolor: "#ccccff" }
            },
            {
              criteria: { source: "^src/module" },
        ...
        //     },
            {
              criteria: { resolved: "^src/SerializerBase" },
              attributes: { color: "#0000ff77" }
            },
            {
              criteria: { resolved: "^src/ModuleBase" },
              attributes: { color: "#00770077" }
            },
            {
              criteria: { resolved: "eventemitter3" },
              attributes: { color: "#99000077" }
            }
          ]
        }
      },
...
// generated: dependency-cruiser@10.2.0 on 2021-09-22T22:56:43.526Z
